...
revoke execute on function public.adjust_customer_points(uuid, integer, text, uuid) from public;
revoke execute on function public.adjust_customer_points(uuid, integer, text, uuid) from anon;
revoke execute on function public.adjust_customer_points(uuid, integer, text, uuid) from authenticated;
grant execute on function public.adjust_customer_points(uuid, integer, text, uuid) to service_role;
